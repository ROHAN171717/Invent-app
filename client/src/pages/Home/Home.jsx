      ...
      <div className="body px-4 sm:px-14 bg-slate-700">
        <div className="navbar pt-5">
          ...
          <div>
            <ul className="menu menu-horizontal px-1">
              {login ? (
                <button
                  className="btn btn-sm text-xl mr-2 pt-1 hover:bg-slate-900 hover:text-zinc-100
                ...
                <>
                  ...
                  <button
                    className="btn btn-sm text-xl pt-1 hover:bg-slate-900 hover:text-zinc-100
                        bg-slate-200 text-black"
                  >
        ...
        <section className="md:flex md:justify-between md:flex-row-reverse pt-20">
          ...
          <div className="inline-block rounded-lg">
            <h1 className="font-bold sm:text-7xl text-6xl text-orange-500">
              Inventory & Stock <br /> Management <br /> Solution
            </h1>
            <br />
            <p className="text-lg text-sky-100">
              Inventory system to control and manage proucts in the <br /> warehouse in real timeand integrated to make
              it easier to <br /> develop your business.
            </p>
            <button
              className="btn  hover:bg-slate-900 hover:text-zinc-100
