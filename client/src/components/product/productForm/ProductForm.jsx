      ...
      <div>
        ...
        <div className='flex justify-center'>
                ...
                <form class="form-control flex justify" onSubmit={saveProduct}>
                    <div className='flex justify-center'>
                        <h1 className='font-bold text-2xl mb-4 bg-orange-500 rounded-xl text-center pt-2 pb-1 text-white w-1/2 shadow-md shadow-orange-50'>{formName}</h1>
                    </div>
                    ...
                    <input type="text" placeholder="Product Name" required name='name' value={product?.name} class="input"
                    onChange={handleInputChange}/>

                    <label class="label">
                        <span class="label-text text-white text-lg">Product Category</span>
                    </label> 
                    <input type="text" placeholder="Product Category" required name='category'
                    value={product?.category}  class="input"
                    onChange={handleInputChange}/>

                    <label class="label">
                        <span class="label-text text-white text-lg">Product Price</span>
                    </label> 
                    <input type="number" placeholder="Product Price" required name='price' min="0" value={product?.price}  class="input"
                    onChange={handleInputChange}/>

                    <label class="label">
                        <span class="label-text text-white text-lg">Product Quantity</span>
                    </label> 
                    <input type="number" placeholder="Product Quantity" required name='quantity'
                    ...
                    <button className='btn btn-sm text-2xl mt-4 normal-case bg-blue-600 text-white
                        hover:bg-blue-400 border-none hover:text-black w-full h-12 shadow-md shadow-blue-300' type='submit'>Save Product</button>
                    </div>
                </form>
                </div>
            </div>
