            ...
            customUI: ({ onClose }) => {
              return (
                <div className='custom-ui rounded-xl text-2xl p-6' style={{backgroundColor:"rgb(55, 74, 93)"}}>
                  ...
                  <button onClick={onClose} className="text-2xl font-semibold rounded-lg m-4 px-4" style={{backgroundColor:"white"}}>No</button>
                  <button
                    onClick={() =>{
                        deleteProduct(id);
                        onClose();
    ...
    <div className='mt-4 body px-8 pb-4'>
      ...
      <div className="overflow-x-auto rounded-2xl">
        {!isLoading && products.length === 0 ? (
            <p className='bg-red-500 text-2xl p-2 text-white' style={{textAlign: 'center',
            backgroundColor: 'rgb(30, 40, 64)'
          }}>-- No products found, Please add a product --</p>
        ):(
