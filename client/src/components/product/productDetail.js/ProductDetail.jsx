  ...
  return (
    <div className='pt-12 pb-4 sm:py-4 body sm:h-full lg:h-[90vh] relative bg-slate-'>
     <button className='btn btn-sm text-xl mt-2 pt-1 normal-case bg-slate-900 text-zinc-100
        ...
        <h3 className='text-5xl font-bold bg-zinc-500 rounded-xl text-center pt-2 text-white shadow-md shadow-orange-50 w-3/5 sm:w-3/5 md:w-1/2 lg:w-1/3 xl:w-1/4 mx-auto my-5'>Product Detail</h3>
        <div>
            {isLoading && <Loader/>}
            {product && 
            ...
            <div className='lg:ml-5 bg-zinc-700 p-4 rounded-xl w-3/4 m-auto sm:w-3/4 lg:w-1/2 lg:m-0 xl:w-1/3 sm:mx-auto sm:mt-4 md:mx-auto mt-8 text-white'>
               <h1 className='text-xl leading-normal'>
                <b>Product Availability :-</b> {stockStatus(product?.quantity)}</h1>

               <hr/>

               <h1 className='text-xl leading-normal'>
                <b>Name :-</b> {product?.name}</h1>
